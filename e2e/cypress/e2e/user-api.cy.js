...
describe("API tests", () => {
  ...
  it("POST - /api/login - should NOT login with unexisting credentials", () => {
    cy.request({
      method: "POST",
  ...
  it("POST - /api/login - should login with existing credentials", () => {
    // Register user
    cy.request({
      method: "POST",
      url: `${apiUrl}/api/user/`,
  ...
  it("POST -  /api/user - should register a user", () => {
  ...
  // POST - /api/user/ registerUser"
  it("POST -  /api/user - should NOT register a user with exisiting credentials", () => {
    // Register credentials
    cy.request({
      method: "POST",
      url: `${apiUrl}/api/user/`,
  ...
  it("GET - /api/users - should retrieve all existing users data", () => {
  ...
  it("GET - /api/user/:id - should retrieve specific user data", () => {
    const userIds = [];
  ...
  it("PATCH - /api/user/:id - should update a specific user's data", () => {
    // Register user
    cy.request({
      method: "POST",
      url: `${apiUrl}/api/user/`,
  ...
  it("DELETE - /api/user/:id - shoudld delete a specific user", () => {
    // Register user
    cy.request({
      method: "POST",
      url: `${apiUrl}/api/user/`,
      ...
      cy.request({
        ...
        expect(res.body.message).to.eq(`User with id: ${userId} not found.`);
      });
    });
  });
});
